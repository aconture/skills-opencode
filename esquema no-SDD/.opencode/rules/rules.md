...
## Git y Commits
1. Nunca ejecutes `git commit`, `git push`, `git init` ni crees pull requests a menos que el usuario lo solicite explícitamente.
2. Cuando ofrezcas un commit propuesto, entrégalo solo como texto sugerido; no lo ejecutes.
